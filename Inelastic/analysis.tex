\begin{figure*}[t!]
	\subfigure[]{\includegraphics[width=0.49\linewidth]{wimp_in_sr.png}}
	\subfigure[]{\includegraphics[width=0.49\linewidth]{bkg_in_sr.png}}
...
{\ale such as to have at least 95\% acceptance to all signal mass hypotheses. The ROI }
%this
...
{\ale where we crosschecked that changing the binning choice does not impact the sensitivity.} 
...
\begin{figure*}[t!]
	\subfigure[]{\includegraphics[width=0.49\linewidth]{mc_ambe_comp_contour.png}}
	\subfigure[]{\includegraphics[width=0.49\linewidth]{test_projections.png}} 
...
{\ale  
The described signal simulation was validated by reproducing the 39.6\,keV xenon line activated from $^{241}$AmBe neutrons and comparing it with data.
For this purpose, the NR energy spectrum expected from inelastic neutron-$^{129}$Xe scatters has been obtained via  Monte Carlo techniques, 
where we take into account the  detector response and the non-uniform spatial distribution of events. The acceptance of our analysis selection criteria to this type of interaction 
have been recomputed. In particular, the acceptance to the double-scatter cut differs greatly between neutron and WIMPs scatters. 
